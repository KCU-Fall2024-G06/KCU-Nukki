...
def apply_mask(mask, image) -> str: # later move to util
    ...
    new_file_path = os.path.join(os.path.dirname(result_dir), new_file_name)
...
def segSam2(path: str, input_points=None) -> str:
    ...
    # if no input_point is given, use default
    if input_points is None:
        input_points = np.array([[360, 650]])
    
    # change array shape by num of input points
